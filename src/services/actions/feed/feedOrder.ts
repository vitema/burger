...
export const GET_FEEDORDER_REQUEST: "GET_FEEDORDER_REQUEST" =
  "GET_FEEDORDER_REQUEST";
export const GET_FEEDORDER_SUCCESS: "GET_FEEDORDER_SUCCESS" =
  "GET_FEEDORDER_SUCCESS";
export const GET_FEEDORDER_FAILED: "GET_FEEDORDER_FAILED" =
